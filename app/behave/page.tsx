...
const Behave = () => {
    ...
    let quiz = [
        ...
        },
        {
            ...
            ans1: { title: 'สวมรองเท้าทุกครั้งที่ออกจากบ้าน', point: 4 },
            ans2: { title: 'ส่วนใหญ่สวมรองเท้า แต่มีบางครั้งที่ไม่ได้สวม', point: 3 },
            ans3: { title: 'สวมรองเท้าบ้างเป็นบางโอกาส', point: 2 },
            ans4: { title: 'สวมรองเท้าเฉพาะบางครั้ง', point: 1 },
            ans5: { title: 'ไม่สวมรองเท้าเลยเมื่ออกจากบ้าน', point: 0 }
        }
    ]
